...
const TrangChu = React.lazy(() => import('./views/dashboard/TrangChu'))
...
// System admin
const Branch = React.lazy(() => import('./views/system/branch/Branch'))
const BranchAdd = React.lazy(() => import('./views/system/branch/BranchAdd'))
const BranchEdit = React.lazy(() => import('./views/system/branch/BranchEdit'))
const Employee = React.lazy(() => import('./views/system/employee/Employee'))
...
const LuongNhanVien = React.lazy(() => import('./views/transaction/Salary'))

const Widgets = React.lazy(() => import('./views/widgets/Widgets'))

const routes = [
  { path: '/', exact: true, name: 'Home' },
  { path: '/trang-chu', name: 'Trang chủ', element: Dashboard },
  { path: '/dashboard', name: 'Trang chủ', element: TrangChu },
  ...
  // system admin
  { path: '/system/branch', name: 'Chi nhánh', element: Branch },
  { path: '/system/branch/add', name: 'Thêm chi nhánh', element: BranchAdd },
  { path: '/system/branch/:id', name: 'Sửa chi nhánh', element: BranchEdit },
  ...
  { path: '/salary', name: 'Lương nhân viên', element: LuongNhanVien },
