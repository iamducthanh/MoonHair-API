...
@Configuration
@EnableWebSecurity
@EnableMethodSecurity(prePostEnabled = true) // Bật dùng @PreAuthorize
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class) // Thêm filter trước UsernamePasswordAuthenticationFilter
